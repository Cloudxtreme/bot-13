...
class IrcBot extends Adapter
  ...
  join: (channel) ->
    ...
    @bot.join channel, () ->
      ...
      self.msgGet new EnterMessage(selfUser)
  ...
  part: (channel) ->
    ...
    @bot.part channel, () ->
      ...
      selfUser = self.getUserFromName self.robot.name
      self.msgGet new LeaveMessage(selfUser)
  ...
  run: ->
    ...
    bot.addListener 'notice', (from, to, message) ->
      ...
      self.msgGet new TextMessage(user, message)
    ...
    bot.addListener 'pm', (nick, message) ->
      ...
      self.msgGet new TextMessage({reply_to: nick, name: nick}, message)

    bot.addListener 'join', (channel, who) ->
      logger.info('%s has joined %s', who, channel)
      user = self.createUser channel, who
      user.room = channel
      self.msgGet new EnterMessage(user)
