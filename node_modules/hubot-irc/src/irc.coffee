...
class IrcBot extends Adapter
  ...
  getMsg: (message) ->
    ...
    #message.text="noIdentify";
    #console.log(message)
    @bot.whois message.user.name, (text) ->
      console.log(text)
      if (text.nick=='NickServ' and text.host='services.') or (text.nick.toLowerCase()==text.account.toLowerCase() and text.accountinfo=='is logged in as')
  ...
  run: ->
    ...
    bot.addListener 'pm', (nick, message) ->
      ...
      self.getMsg new TextMessage({reply_to: nick, name: nick}, message)
